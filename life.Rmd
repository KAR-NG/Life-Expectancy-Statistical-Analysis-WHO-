...
* 657 rows of observation have 4.5% of missing values horizontally across variables.

* 360 rows of observations have 9.1% of missing values horizontally across variables.

* 9 rows of observations have 40.9% of missing values (maximum amount) horizontally across variables.  
...
## White Space Trimming and punctuation removal
